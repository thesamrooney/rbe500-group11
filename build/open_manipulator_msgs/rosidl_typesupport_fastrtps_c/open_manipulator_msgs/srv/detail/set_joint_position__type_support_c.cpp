...
static size_t _SetJointPosition_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_open_manipulator_msgs__srv__SetJointPosition_Request(
...
static size_t _SetJointPosition_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_open_manipulator_msgs__srv__SetJointPosition_Response(
    full_bounded, is_plain, 0);
