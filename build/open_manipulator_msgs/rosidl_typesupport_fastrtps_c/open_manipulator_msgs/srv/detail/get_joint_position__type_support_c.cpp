...
static size_t _GetJointPosition_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_open_manipulator_msgs__srv__GetJointPosition_Request(
...
static size_t _GetJointPosition_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_open_manipulator_msgs__srv__GetJointPosition_Response(
    full_bounded, is_plain, 0);
